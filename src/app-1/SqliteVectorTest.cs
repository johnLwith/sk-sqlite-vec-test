...
// Store each article's paragraphs
        for (int articleId = 0; articleId < articles.Length; articleId++)
        {
            ...
            for (int paraId = 0; paraId < paragraphs.Length; paraId++)
            {
                ...
                var document = new Document
                {
                    ...
                    Content = paragraph,
                    Embedding = OllamaTextEmbeddingGeneration.GenerateTextEmbedding(paragraph).Result[0]
                };
        ...
        var searchEmbedding = OllamaTextEmbeddingGeneration.GenerateTextEmbedding(searchValue).Result[0];
